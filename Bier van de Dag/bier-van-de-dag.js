...
document.addEventListener('DOMContentLoaded', () =>{
    const bierData = [
...

        {
            ...
            stijl: "Lambic - Gueuze",
            beschrijving: "3 Fonteinen Oude Geuze Cuvee Armand & Gaston is een Belgische geuze van wereldklasse, vernoemd naar Armand Debelder en zijn zoon Gaston. Het bier wordt traditioneel geproduceerd door het blenden van verschillende leeftijden lambiek en hergist op fles. Het resultaat is een complexe en evenwichtige smaak met tonen van citrus en groene appel, dankzij wilde gisten. Cuvee Armand & Gaston wordt beschouwd als een hoogtepunt van vakmanschap binnen de wereld van geuzebieren.",
...

        {
            ...
            stijl: "Sour IPA",
            beschrijving: "Uit de Gentse wateren ontspringt vandaag een biertje met Brusselse nasmaak. BierKultuur stelt trots haar smaakmakend kindje voor. Onze zure, hoppige bébé. Onze à plein verre. Student, liefhebber of eender wie: tiens ton verre et le bonheur en main!",
